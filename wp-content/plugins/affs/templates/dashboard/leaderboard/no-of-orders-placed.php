<?php
/**
 * This template is used for display dashboard leaderboard no of order placed.
 *
 * This template can be overridden by copying it to yourtheme/affs/dashboard/leaderboard/no-of-order-placed.php
 *
...
/**
 * This hook is used to do extra action after affiliates dashboard number of order placed
 * 
 * @since 10.0.0
 */
do_action('fs_affiliates_before_dashboard_leaderboard_total_order_placed');
?>
<table class='fs_affiliates_leaderboard_frontend_table fs_affiliates_leaderboard_frontend_table_four fs_affiliates_frontend_table' data-display_type='<?php echo wp_kses_post($display_type); ?>' data-table_name='fs-no-of-orders-placed'>
	<tbody>
		<tr>
 ...
 * @since 10.0.0
 */
do_action('fs_affiliates_after_dashboard_leaderboard_total_leader_board');
