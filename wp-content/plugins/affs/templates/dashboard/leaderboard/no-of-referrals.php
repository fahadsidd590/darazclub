<?php
/**
 * This template is used for display dashboard commission earned.
 *
 * This template can be overridden by copying it to yourtheme/affs/dashboard/leaderboard/commission-earned.php
 *
...
/**
 * This hook is used to do extra action before dashboard leader board no of referrals
 * 
 * @since 10.0.0
 */
do_action('fs_affiliates_before_dashboard_leaderboard_no_of_referrals');
?>
<div class ='fs_affiliates_form'>    
	...
	<table class='fs_affiliates_leaderboard_frontend_table fs_affiliates_leaderboard_frontend_table_two fs_affiliates_frontend_table' data-display_type='<?php echo wp_kses_post($display_type); ?>' data-table_name='fs-no-of-referrals'>
		<tbody>
			<tr>
...
<?php
/**
 * This hook is used to do extra action after dashboard leader board no of referrals
 * 
 * @since 10.0.0
 */
do_action('fs_affiliates_after_dashboard_leaderboard_no_of_referrals');
