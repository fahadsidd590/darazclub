...
/**
 * This hook is used to do extra action after affiliates dashboard commission earned.
 * 
 * @since 10.0.0
 */
do_action('fs_affiliates_before_dashboard_leaderboard_commission_earned');
?>
<div class ='fs_affiliates_form'>    
	...
	<table class='fs_affiliates_leaderboard_frontend_table fs_affiliates_leaderboard_frontend_table_one fs_affiliates_frontend_table' data-display_type='<?php echo wp_kses_post($display_type); ?>' data-table_name='fs-commission-earned'>
		<tbody>
			<tr>
 ...
 * @since 10.0.0
 */
do_action('fs_affiliates_after_dashboard_leaderboard_commission_earned');
