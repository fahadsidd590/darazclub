...
<tr>
	...
	<td>
		<p class="fs_affiliates_remove_mlm_rule fs_affiliates_remove_mlm_category_rule"> <img src="<?php echo esc_url( FS_AFFILIATES_PLUGIN_URL . '/assets/images/x-mark-3-24.png' ) ; ?>"></img></p>
	</td>
</tr>
<?php
