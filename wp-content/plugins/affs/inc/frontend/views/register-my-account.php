...
<div class="fs_affiliates_checkbox_wrapper" style="display:<?php echo $checkbox_status; ?>;">
	<input type="checkbox" name="<?php echo $checkout_field_name; ?>" class="fs_affiliates_form_show" id="fs_affiliates_form_show" 
	<?php
	if (isset($_POST["$checkout_field_name"])) {
		?>
			   checked="checked" <?php } ?> value="yes" >&nbsp;<?php echo __('Register as an Affiliate?'); ?>
</div>
