...
class QRImage extends QROutputAbstract {
	...
	protected $moduleValues = array(
		// light
		QRMatrix::M_DATA            => array( 255, 255, 255 ),
		QRMatrix::M_FINDER          => array( 255, 255, 255 ),
		QRMatrix::M_SEPARATOR       => array( 255, 255, 255 ),
		QRMatrix::M_ALIGNMENT       => array( 255, 255, 255 ),
		QRMatrix::M_TIMING          => array( 255, 255, 255 ),
		QRMatrix::M_FORMAT          => array( 255, 255, 255 ),
		QRMatrix::M_VERSION         => array( 255, 255, 255 ),
		QRMatrix::M_QUIETZONE       => array( 255, 255, 255 ),
		QRMatrix::M_TEST            => array( 255, 255, 255 ),
		// dark
		QRMatrix::M_DARKMODULE << 8 => array( 0, 0, 0 ),
		QRMatrix::M_DATA << 8       => array( 0, 0, 0 ),
		QRMatrix::M_FINDER << 8     => array( 0, 0, 0 ),
		QRMatrix::M_ALIGNMENT << 8  => array( 0, 0, 0 ),
		QRMatrix::M_TIMING << 8     => array( 0, 0, 0 ),
		QRMatrix::M_FORMAT << 8     => array( 0, 0, 0 ),
		QRMatrix::M_VERSION << 8    => array( 0, 0, 0 ),
		QRMatrix::M_TEST << 8       => array( 0, 0, 0 ),
	);
	...
	protected function dumpImage(): string {
		...
		try {
			call_user_func(array( $this, $this->outputMode ?? $this->defaultMode ));
		}
